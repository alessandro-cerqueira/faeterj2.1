...
const INICIAR_EXCLUIR_LINGUAGEM = "/iniciarExcluirLinguagem";
...
module.exports = {
  configurar: async(srv) => {
    ...
    servidor.post(EXCLUIR_LINGUAGEM, module.exports.excluir);
  },
  ...
  excluir: async (request, reply) => {
    ...
    if (request.body.nome) 
      votos = await db.excluirLinguagem(request.body.nome);
